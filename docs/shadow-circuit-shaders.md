...
Cinematic mode now reserves additional memory, increases shadow-map resolution, and preloads objective and character GLBs while staying under the `320 MB` advisory cap in browser smoke testing.
